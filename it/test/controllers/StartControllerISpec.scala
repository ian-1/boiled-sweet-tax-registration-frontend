...
class StartControllerISpec extends IntegrationSpecHelper {

  "GET /start" should {
    val result = get("/start")
    ...
    "return the correct view" in {
      ...
      document.title shouldBe "Sell Boiled Sweets - Boiled Sweet Tax Registration - GOV.UK"
